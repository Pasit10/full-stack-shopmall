...
$topSellingData = getTopSellingReport();
...
if (isset($_GET['download_pdf'])) {
    ...
    <body>
        <h2 style="text-align: center;">Top Selling Report</h2>
        <table>
            <thead>
                <tr>
                    <th>Product Name</th>
            ...
            <tbody>
                <?php if (!empty($topSellingData)): ?>
                    <?php foreach ($topSellingData as $row): ?>
                        <tr>
    ...
    $mpdf->WriteHTML($html);
    $mpdf->Output("Top_Selling_Report.pdf", "D");
    exit;
}
?>
...
<body>
    ...
    <div class="report-container">
        <div class="report-header">Top Selling Report</div>
