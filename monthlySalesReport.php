...
$monthlySalesData = getMonthlySalesReport();
...
if (isset($_GET['download_pdf'])) {
        ...
        <table>
            ...
            <tbody>
                <?php if (!empty($monthlySalesData)): ?>
                    <?php foreach ($monthlySalesData as $row): ?>
                        <tr>
    ...
    $html = ob_get_clean();
    $mpdf->WriteHTML($html);
    $mpdf->Output("Monthly_Sales_Report.pdf", "D");
    exit;
}
?>
...
<body>
    ...
    <div class="report-container">
        <div class="report-header">Monthly Sales Report</div>
        <table>
            <thead>
                <tr>
                    <th>Month</th>
