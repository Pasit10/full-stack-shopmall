...
$revenueByProductData = getRevenuebyProductReport();
...
if (isset($_GET['download_pdf'])) {
    ...
    <body>
        <h2 style="text-align: center;">Revenue by Product Report</h2>
        <table>
            <thead>
                <tr>
                    <th>Product Name</th>
            ...
            <tbody>
                <?php if (!empty($revenueByProductData)): ?>
                    <?php foreach ($revenueByProductData as $row): ?>
                        <tr>
    ...
    $html = ob_get_clean();
    $mpdf->WriteHTML($html);
    $mpdf->Output("Revenue_by_Product_Report.pdf", "D");
    exit;
}
?>
...
<head>
    ...
    <title>Top Selling Report</title>
...
<body>
    ...
    <div class="report-container">
        <div class="report-header">Revenue by Product Report</div>
        <table>
            <thead>
                <tr>
                    <th>Product Name</th>
