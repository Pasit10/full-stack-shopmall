...
$adminActivityData = getAdminActivityReport();
...
if (isset($_GET['download_pdf'])) {
    ...
    <body>
        <h2 style="text-align: center;">Admin Activity Report</h2>
        <table>
            <thead>
                <tr>
                    <th>Admin ID</th>
            ...
            <tbody>
                <?php if (!empty($adminActivityData)): ?>
                    <?php foreach ($adminActivityData as $row): ?>
                        <tr>
    ...
    $html = ob_get_clean();
    $mpdf->WriteHTML($html);
    $mpdf->Output("Admin_Activity_Report.pdf", "D");
    exit;
}
?>
...
<body>
    ...
    <div class="report-container">
        <div class="report-header">Admin Activity Report</div>
        <table>
            <thead>
                <tr>
                    <th>Admin ID</th>
